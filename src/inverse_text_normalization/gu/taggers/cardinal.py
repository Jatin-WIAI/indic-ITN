...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        fraction_word_graph_1 = get_graph(fraction_words_dict["FRACX.5"],"FRACX.5")
        fraction_word_graph_2 = get_graph(fraction_words_dict["FRACX.75"],"FRACX.75")
        ...
        fst = pynini.union(
            ...
            special_words_graph,
            fraction_word_graph_1,
            fraction_word_graph_2,
